        ...
        <div className="p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center space-x-3 bg-white border-2 border-gray-200 hover:border-urbane-gold text-gray-700 font-medium py-3 px-4 rounded-lg transition-all opacity-60 cursor-not-allowed"
