...
const SoldOutBanner: React.FC<{ onNotifyClick?: () => void }> = ({ onNotifyClick }) => (
  <div className="text-center bg-[#C84B0F]/8 border border-[#C84B0F]/40 rounded-2xl px-6 py-8">
    <p className="text-[#C84B0F] text-xs uppercase tracking-[0.3em] font-bold mb-3">
      Sold Out
    </p>
    ...
    {onNotifyClick && (
      <button
        ...
        className="bg-[#D4A574] hover:bg-[#e6bd8e] text-[#1C1C1C] font-semibold px-6 py-3 rounded-full uppercase tracking-[0.15em] text-xs transition shadow-md"
      >
        Join the wait-list
      </button>
    )}
