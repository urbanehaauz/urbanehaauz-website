...
export const ROUTES_META: RouteMeta[] = [
  ...
  },
  {
    ...
    description:
      'Rangotsav — a Bengal-Sikkim cultural celebration in Pelling, West Sikkim. 25–26 May 2026 · ₹100/day or ₹175 for both days. Hosted by Urbane Haauz.',
    ogImage: `${SITE}/rangotsav-ganesh.jpeg`,
    ogType: 'event',
    canonical: `${SITE}/rangotsav`,
    h1: 'Rangotsav · The Tale Of Two States',
    lede: [
      "Rangotsav 2026 — a two-day Bengal-Sikkim cultural conglomerate at Urbane Haauz, Upper Pelling, on 25–26 May 2026. Art, music, folk performances, cuisine. Day passes ₹100, both-day bundle ₹175 (₹25 off); capacity 300 per day.",
    ],
  },
  {
    path: '/pelling-2.0',
