               ...
               <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
                  ...
                  <div className="space-y-12">
                      ...
                      <div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                               <div className="col-span-2 relative h-48 rounded-lg overflow-hidden border-2 border-dashed border-gray-300 group">
                                  <img src={homeHeroImage} alt="Home Hero" width={600} height={192} loading="lazy" decoding="async" className="w-full h-full object-cover" />
                      ...
                      <div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                               <div className="col-span-2 relative h-48 rounded-lg overflow-hidden border-2 border-dashed border-gray-300 group">
                                  <img src={adminBackgroundImage} alt="Admin Background" width={600} height={192} loading="lazy" decoding="async" className="w-full h-full object-cover" />
                                  <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                      <label className="cursor-pointer bg-white text-gray-900 px-4 py-2 rounded font-bold text-xs uppercase tracking-wider hover:bg-urbane-gold hover:text-white transition-colors">
                                          Change Image
                ...
                {rooms.map(room => (
                    <div key={room.id} className="bg-white rounded-xl overflow-hidden shadow-lg group border border-gray-100">
                        <div className="relative h-48 overflow-hidden">
                             <img src={room.image} alt={room.name} width={600} height={192} loading="lazy" decoding="async" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
