  ...
  <section className="py-28 md:py-36 relative overflow-hidden bg-[#2D1B69] text-[#FAF7F2]">
    ...
    <Reveal delay={150}>
      <div className="relative">
        <div className="absolute left-0 top-0 bottom-0 w-16 md:w-32 bg-gradient-to-r from-[#2D1B69] to-transparent z-10 pointer-events-none" />
        <div className="absolute right-0 top-0 bottom-0 w-16 md:w-32 bg-gradient-to-l from-[#2D1B69] to-transparent z-10 pointer-events-none" />
        ...
        <div className="overflow-x-auto scrollbar-hide snap-x snap-mandatory">
          <div className="flex gap-6 px-6 md:px-24 pb-4">
            {ARTISTS.map((a, i) => (
              ...
              >
                <div
                  className="w-32 h-32 rounded-full mx-auto mb-5 relative overflow-hidden"
                  style={{
    ...
    <Reveal delay={250}>
      <div className="text-center mt-12 max-w-lg mx-auto px-6">
        <p className="text-[#FAF7F2]/60 italic">
          Artist lineup to be announced. Names above are placeholders.
        </p>
      </div>
    </Reveal>
  </section>
